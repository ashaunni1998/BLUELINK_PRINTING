  ...
  return (
    <div className="relative bg-gradient-to-b from-blue-50 via-white to-blue-50">
        ...
        <div 
          ...
          style={{
            backgroundImage: `
              ...
              radial-gradient(circle at 80% 20%, #60a5fa 1px, transparent 1px)
            `,
        ...
        <div className="relative z-10 container mx-auto px-4">
          ...
          <div className="text-center mb-16">
            ...
            <h2 className="text-4xl lg:text-5xl font-black text-gray-900 mb-4">
              Creative <span className="bg-gradient-to-r from-blue-500 to-blue-700 bg-clip-text text-transparent">Showcase</span>
            </h2>
          ...
          <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 max-w-6xl mx-auto">
            ...
            {/* Business Cards Card */}
            <div 
              className={`group relative bg-white rounded-3xl overflow-hidden shadow-2xl border border-blue-100 transform transition-all duration-500 hover:scale-105 hover:shadow-3xl ${
            ...
            >
              {/* Glow Effect */}
              <div className="absolute -inset-1 bg-gradient-to-r from-blue-400 to-blue-600 opacity-20 blur-xl group-hover:opacity-40 transition-opacity duration-300" />
              ...
              <div className="relative">
                ...
                <div className="p-8">
                  ...
                  {/* CTA */}
                  <button className="group/btn w-full flex items-center justify-center gap-2 px-6 py-4 bg-gradient-to-r from-blue-500 to-blue-600 text-white font-semibold rounded-2xl shadow-lg hover:shadow-xl transform transition-all duration-300 hover:scale-[1.02]">
                    Read More
      ...
      <section 
        id="flyers-section"
        data-animate
        className={`relative py-20 lg:py-32 overflow-hidden transition-all duration-1000 delay-200 ${
      ...
      >
        ...
        <div className="absolute inset-0">
          ...
          <div className="absolute bottom-20 right-10 w-80 h-80 bg-blue-300/20 rounded-full blur-3xl animate-pulse" style={{ animationDelay: '2s' }} />
        </div>
        ...
        <div className="relative z-10 container mx-auto px-4">
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center max-w-7xl mx-auto">
            ...
            <div className="relative group order-2 lg:order-1">
              <div className="absolute -inset-4 bg-gradient-to-r from-blue-400 to-blue-600 opacity-30 blur-2xl rounded-3xl group-hover:opacity-50 transition-opacity duration-500" />
              
              <div className="relative bg-white/80 backdrop-blur-lg p-6 rounded-3xl border border-blue-200 shadow-2xl">
                <img
                  src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQd19vInA8bUX20OregUR32xvV6CbNZ_kMhDQ&s"
                  alt="Flyers & Leaflets"
                  className="w-full rounded-2xl shadow-xl transform group-hover:scale-[1.02] transition-transform duration-500"
                />
                ...
                <div className="absolute -bottom-6 -left-6 bg-gradient-to-r from-blue-500 to-blue-600 text-white rounded-2xl p-4 shadow-xl">
                  <div className="text-center">
            ...
            <div className="space-y-8 order-1 lg:order-2">
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <button className="group flex items-center justify-center gap-2 px-8 py-4 bg-gradient-to-r from-blue-500 to-blue-600 text-white font-bold rounded-2xl shadow-xl hover:shadow-2xl transform transition-all duration-300 hover:scale-105">
      ...
      >
        {/* Background Elements */}
        <div className="absolute inset-0">
          <div className="absolute top-32 right-20 w-72 h-72 bg-blue-200/20 rounded-full blur-3xl animate-pulse" style={{ animationDelay: '1s' }} />
          <div className="absolute bottom-10 left-20 w-96 h-96 bg-blue-300/15 rounded-full blur-3xl animate-pulse" style={{ animationDelay: '3s' }} />
        </div>
          ...
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center max-w-7xl mx-auto">
            ...
            <div className="relative group">
              ...
              <div className="relative bg-white/80 backdrop-blur-lg p-6 rounded-3xl border border-blue-200 shadow-2xl">
                ...
                <div className="absolute -bottom-6 -right-6 bg-gradient-to-r from-blue-500 to-blue-600 text-white rounded-2xl p-4 shadow-xl">
                  <div className="text-center">
                    <div className="text-xl font-black">🎁</div>
                    <div className="text-xs opacity-90">Special</div>
                  </div>
                </div>
              </div>
            </div>
