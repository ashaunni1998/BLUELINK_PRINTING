...
const FlyerSection = () => {
  ...
  return (
    ...
    <section className="relative bg-blue-50 overflow-hidden py-8 md:py-12 lg:py-16" style={{ width: "100%", margin: "0" }}>
  {/* Container */}
  ...
  <div className="w-24 h-1.5 bg-blue-600 rounded-full" />
            ...
            {/* Description */}
<p className="text-base md:text-lg lg:text-xl text-gray-700 leading-relaxed">              Elevate your marketing with stunning flyer designs. 
  ...
  <div className="relative bg-white p-0 rounded-3xl border-2 border-blue-200">
    <div
      className="w-full h-96 md:h-[28rem] lg:h-[32rem] rounded-2xl bg-cover bg-center transform group-hover:scale-105 transition-transform duration-500"
      style={{
